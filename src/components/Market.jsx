...
function Market() {
  return (
    <Container className="market-section">
      ...
      <Accordion defaultActiveKey="0" className="market-card-container">
        <Card>
          <Card.Header>
            <Accordion.Toggle
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="2">
            <Card.Body>
              Then we use that information to create your card! And don't worry,
              we're not interested in selling your information!
            </Card.Body>
          </Accordion.Collapse>
        </Card>
      </Accordion>
